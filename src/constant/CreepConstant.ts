...
export const RoleLevelData = {
    'harvester': {
        ...
        2: { bodypart: [[WORK, 4], [CARRY, 1], [MOVE, 2]], num: 0 },
        3: { bodypart: [[WORK, 6], [CARRY, 1], [MOVE, 3]], num: 0 },
    ...
    'transport': {
        ...
        7: { bodypart: [[CARRY, 26], [MOVE, 13]], num: 1 },
        8: { bodypart: [[CARRY, 33], [MOVE, 17]], num: 1 },
    },
    'manager': {
        1: { bodypart: [[CARRY, 1], [MOVE, 1]], num: 0 },
        2: { bodypart: [[CARRY, 1], [MOVE, 1]], num: 0 },
    ...
    "aid-build": {
        ...
        4: { bodypart: [[WORK, 5], [CARRY, 4], [MOVE, 9]], num: 0 },
        5: { bodypart: [[WORK, 6], [CARRY, 6], [MOVE, 12]], num: 0 },
        6: { bodypart: [[WORK, 8], [CARRY, 8], [MOVE, 16]], num: 0 },
        7: { bodypart: [[WORK, 10], [CARRY, 10], [MOVE, 20]], num: 0 },
        8: { bodypart: [[WORK, 13], [CARRY, 12], [MOVE, 25]], num: 0 },
    },
    "aid-upgrade": {
